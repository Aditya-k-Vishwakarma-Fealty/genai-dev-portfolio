    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 h-full">
        <div className="flex flex-col lg:flex-row items-center justify-between h-full gap-8 lg:gap-12">
          {/* Content Section */}
          <div className="flex-1 lg:flex-[0.65] animate-fade-in-up text-center lg:text-left order-2 lg:order-1">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 bg-gradient-text bg-clip-text text-transparent leading-tight">
              Aditya Kumar Vishwakarma
            </h1>
            
            <p className="text-base sm:text-lg md:text-xl bg-gradient-text bg-clip-text text-transparent mb-4 sm:mb-6">
              GenAI Full Stack Developer | 1+ Years Experience
            </p>
            
            <p className="text-sm sm:text-base text-muted-foreground mb-6 sm:mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0">
          ...
          {/* Image Section */}
          <div className="flex-1 lg:flex-[0.35] flex items-center justify-center order-1 lg:order-2 mb-8 lg:mb-0">
